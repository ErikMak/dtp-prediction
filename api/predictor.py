...
class Predictor:
    ...
    def predict(self, data: data_model.Data):
        try:
            ...
            wd, td = self.weather.get_current_weather(data.lat, data.long)
            ...
            od = self.ob.get_objects_nearby(data.lat, data.long)
            ...
            cluster = self.clusterer.predict(data.lat, data.long)
